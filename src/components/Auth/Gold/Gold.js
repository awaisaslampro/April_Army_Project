           ...
           <div className="row d-flex justify-content-center align-items-center ">
                ...
                <div className="bronzeAwardContainer ">
                    ...
                    <div className="bronzeAward">
                        <img className="bronzeMedal" src={"./assets/img/quiz-75.png"} />

                        <div className="bronzeAwardStatus">
                        <div>
                        <Link to="/awards"><input className="bronzeButton" style ={{backgroundColor:'#c5a030'}} type="button" value="Gold" ></input></Link>
                      </div>  
                      <div>
