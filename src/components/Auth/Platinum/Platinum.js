           ...
           <div className="row d-flex justify-content-center align-items-center ">
                ...
                <div className="bronzeAwardContainer ">
                    <div className="bronzeAward">
                        <img className="bronzeMedal" src={"./assets/img/posts-50.png"} />

                        <div className="bronzeAwardStatus">
                        <div>
                        <Link to="/awards"><input className="bronzeButton" style ={{backgroundColor: '#b6bcc1'}}type="button" value="Platinum" ></input></Link>
                      </div>  
                      <div>
